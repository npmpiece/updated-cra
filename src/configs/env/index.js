...
module.exports = config => {
  const babelConfig = loadFromPackageField('babel') || nameOnly(resolveFromRoot('.babelrc') || resolveFromRoot('config.babel'))

  const eslintConfig = loadFromPackageField('eslintConfig') || nameOnly(resolveFromRoot('.eslintrc') || resolveFromRoot('config.eslint'))
